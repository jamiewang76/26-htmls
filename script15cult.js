...
function speech(){
      if(image=="1"){
        document.getElementById("speech").src = "intro1/consequences2.png";
        document.getElementById("speech").style.width= "500px";
        document.getElementById("speech").style.height= "230px";
        image="2";
      }
      else if(image=="2"){
        document.getElementById("speech").src = "intro1/killed2.png";
        ...
        document.getElementById("speech").style.width= "830px";
        document.getElementById("speech").style.height= "230px";
        image="5";
      }
      else if(image=="5"){
